...
<script>
	export default {
		...
		methods: {
            ...
            <span>
              <el-button type="primary" style="padding: 3px;font-size: 11px;margin-top: 0px;float: left;" size="small" on-click={ () => this.append(data) }>添加部门</el-button>
              <el-button type="danger" style="padding: 3px;font-size: 11px;margin-top: 0px;float: left;" size="small" on-click={ () => this.remove(node, data) }>删除部门</el-button>
            </span>
          	</span>
				);
			}
